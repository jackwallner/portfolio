...
const CURATED = [
    ...
    { repo: 'bridge', name: 'Bridge Trainer', icon: 'bridge-icon.png', type: 'iOS App', status: 'Pre-release', cls: 'soon', link: 'https://jackwallner.github.io/bridge/', ext: true, start: '2026-07-11', updated: '2026-07-18', desc: 'Five-minute contract bridge practice for card basics, bidding, declarer play, and defense.' },
    { repo: 'mahj', name: 'Mahj Trainer', icon: 'mahj-icon.png', type: 'iOS App', status: 'Pre-release', cls: 'soon', link: 'https://jackwallner.github.io/mahj/', ext: true, start: '2026-07-11', updated: '2026-07-18', desc: 'Short practice rooms for American Mah Jongg tiles, card reading, Charleston, and table judgment.' },
    { repo: 'vo2max', name: 'VO2 Max Daily Tracker', icon: 'vo2max-icon.png', type: 'iOS App', status: 'Pre-release', cls: 'soon', link: 'https://jackwallner.github.io/vo2max/', ext: true, start: '2026-07-15', updated: '2026-07-18', desc: 'A focused view of Apple Health cardio fitness estimates, trends, targets, and history.' },
    { repo: 'dreamcart-ios', name: 'DreamCart: Dopamine Shopping', icon: 'dreamcart-icon.png', type: 'iOS App', status: 'Pre-release', cls: 'soon', link: 'dreamcart/', ext: false, start: '2026-07-06', updated: '2026-07-18', desc: 'A virtual fashion shopping game with daily coins, cart checkout, and a dream closet.' },
