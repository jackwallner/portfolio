...
const CURATED = [
    ...
    { repo: 'football', name: 'Football Next: StatScout', icon: 'football-icon.png', type: 'iOS App', status: 'Pre-release', cls: 'soon', link: 'https://jackwallner.github.io/football/', ext: true, start: '2026-07-20', updated: '2026-07-28', desc: 'Every NFL player ranked by percentile, with advanced stats in plain visual form.' },
