...
const CURATED = [
    ...
    { repo: 'baseball', name: 'Baseball Savvy StatScout', icon: 'statscout-icon.png', type: 'iOS App', status: 'App Store', cls: 'live', link: 'statscout/', ext: false, start: '2026-04-10', updated: '2026-07-09', desc: 'Mobile-first Statcast player cards and leaderboards.' },
    ...
    { repo: 'queasy', name: 'Queasy', icon: 'queasy-icon.png', type: 'iOS App', status: 'Coming soon', cls: 'soon', link: 'https://jackwallner.github.io/queasy/', ext: true, start: '2026-07-01', updated: '2026-07-08', desc: 'Anti-nausea haptics on Apple Watch, inspired by P6 acupressure wristbands.' },
