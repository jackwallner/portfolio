...
const CURATED = [
    ...
    { repo: 'sober', name: 'Sober: Sobriety Day Counter', icon: 'sober-icon.png', type: 'iOS App', status: 'App Store', cls: 'live', link: 'https://jackwallner.github.io/sober/', ext: true, start: '2026-05-15', updated: '2026-07-26', desc: 'Day counter with a virtual garden that grows as sober days add up.' },
    ...
    { repo: 'posture', name: 'Posture Coach: Sit Straight', icon: 'posture-icon.png', type: 'iOS App', status: 'App Store', cls: 'live', link: 'https://jackwallner.github.io/posture/', ext: true, start: '2026-06-01', updated: '2026-07-18', desc: 'Reads your alignment from AirPods head-motion sensors and nudges you upright.' },
    { repo: 'bridge', name: 'Bridge Trainer: Learn & Bid', icon: 'bridge-icon.png', type: 'iOS App', status: 'App Store', cls: 'live', link: 'https://jackwallner.github.io/bridge/', ext: true, start: '2026-07-11', updated: '2026-07-18', desc: 'Five-minute contract bridge practice for card basics, bidding, declarer play, and defense.' },
    { repo: 'mahj', name: 'Mahj Trainer: Mahjong Practice', icon: 'mahj-icon.png', type: 'iOS App', status: 'App Store', cls: 'live', link: 'https://jackwallner.github.io/mahj/', ext: true, start: '2026-07-11', updated: '2026-07-18', desc: 'Short practice rooms for American Mah Jongg tiles, card reading, Charleston, and table judgment.' },
    { repo: 'vo2max', name: 'VO2 Max & Cardio Fitness', icon: 'vo2max-icon.png', type: 'iOS App', status: 'App Store', cls: 'live', link: 'https://jackwallner.github.io/vo2max/', ext: true, start: '2026-07-15', updated: '2026-07-18', desc: 'A focused view of Apple Health cardio fitness estimates, fitness age, trends, and targets.' },
    { repo: 'dreamcart-ios', name: 'DreamCart: Dopamine Shopping', icon: 'dreamcart-icon.png', type: 'iOS App', status: 'App Store', cls: 'live', link: 'dreamcart/', ext: false, start: '2026-07-06', updated: '2026-07-18', desc: 'A virtual fashion shopping game with daily coins, cart checkout, and a dream closet.' },
    { repo: 'queasy', name: 'Queasy: Wrist Comfort Aid', icon: 'queasy-icon.png', type: 'iOS App', status: 'In review', cls: 'soon', link: 'https://jackwallner.github.io/queasy/', ext: true, start: '2026-07-01', updated: '2026-07-14', desc: 'Drug-free wrist comfort haptics on Apple Watch, inspired by P6 acupressure bands.' },
    { repo: 'football', name: 'Football Next Play: StatScout', icon: 'football-icon.png', type: 'iOS App', status: 'Pre-release', cls: 'soon', link: 'https://jackwallner.github.io/football/', ext: true, start: '2026-07-20', updated: '2026-07-28', desc: 'Every NFL player ranked by percentile, with advanced stats in plain visual form.' },
