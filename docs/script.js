...
const CURATED = [
    ...
    { repo: 'queasy', name: 'Queasy', icon: 'queasy-icon.png', type: 'iOS App', status: 'Coming soon', cls: 'soon', link: 'https://jackwallner.github.io/queasy/', ext: true, start: '2026-07-01', updated: '2026-07-03', desc: 'Reliefband-style anti-nausea haptics your Apple Watch plays on the P6 acupressure point.' },
